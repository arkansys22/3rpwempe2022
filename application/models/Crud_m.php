...
class Crud_m extends CI_model{
  ...
  public function view_join_where($table1,$table2,$field,$where)
  {
    ...
    public function view_join_where_only($table1,$table2,$field,$field2,$where)
    {
          $this->db->select('*');
          $this->db->from($table1);
  ...
  public function view_wheres($table,$data)
  {
      $this->db->where($data);
      $query = $this->db->get($table);
      return $query->result_array();
  ...
  public function view_where_result($table,$data)
  {
      $this->db->where($data);
      $query = $this->db->get($table);
      return $query->result_array();

...
class Aspanel extends CI_Controller {
	...
	public function home()
	{
		if ($this->session->level=='1'){
			...
			cek_session_akses_direktur('home',$this->session->id_session);
			$data['record_company_sub'] = $this->Crud_m->view_where_ordering('user_company',array('user_company_kategori'=>'2'),'user_company_id','ASC');
			$this->load->view('backend/home', $data);

		}elseif ($this->session->level=='4') {
			cek_session_akses_general_manager('home',$this->session->id_session);
			$data['record_company_sub'] = $this->Crud_m->view_where_ordering('user_company',array('user_company_kategori'=>'2'),'user_company_id','ASC');
			$this->load->view('backend/home', $data);

		}elseif ($this->session->level=='5') {
			cek_session_akses_manager('home',$this->session->id_session);
			$data['record_company_sub'] = $this->Crud_m->view_where_ordering('user_company',array('user_company_kategori'=>'2'),'user_company_id','ASC');
			$this->load->view('backend/home', $data);

		}elseif ($this->session->level=='6') {
			cek_session_akses_supervisor('home',$this->session->id_session);
			$data['record_company_sub'] = $this->Crud_m->view_where_ordering('user_company',array('user_company_kategori'=>'2'),'user_company_id','ASC');
			$this->load->view('backend/home', $data);

		}elseif ($this->session->level=='7') {
			cek_session_akses_staff('home',$this->session->id_session);
			$data['record_company_sub'] = $this->Crud_m->view_where_ordering('user_company',array('user_company_kategori'=>'2'),'user_company_id','ASC');
			$this->load->view('backend/home', $data);
		}else{
			redirect(base_url());
	...
	public function profil()
	{
		...
		$data = array('record' => $proses);
			...
			if ($this->session->level=='1'){
				...
				cek_session_akses_staff('profil',$this->session->id_session);
				$data['record_company_sub'] = $this->Crud_m->view_where_ordering('user_company',array('user_company_kategori'=>'2'),'user_company_id','ASC');
				$data['recordall'] = $this->Crud_m->view_where_ordering('user',array('user_status'=>'1'),'id_user','DESC');
				$this->load->view('backend/profil/profilall', $data);
			}elseif ($this->session->level=='4') {
				cek_session_akses_manager('profil',$this->session->id_session);
				$data['record_company_sub'] = $this->Crud_m->view_where_ordering('user_company',array('user_company_kategori'=>'2'),'user_company_id','ASC');
				$data['recordall'] = $this->Crud_m->view_where_ordering('user',array('user_status'=>'1'),'id_user','DESC');
				$this->load->view('backend/profil/profilall', $data);
			}elseif ($this->session->level=='5') {
				cek_session_akses_bod('profil',$this->session->id_session);
				$data['record_company_sub'] = $this->Crud_m->view_where_ordering('user_company',array('user_company_kategori'=>'2'),'user_company_id','ASC');
				$data['recordall'] = $this->Crud_m->view_where_ordering('user',array('user_status'=>'1'),'id_user','DESC');
				$this->load->view('backend/profil/profilall', $data);
			}else{
  ...
  public function exportxlskonsumen()
  {
	...
	public function company()
	{
					if ($this->session->level=='1'){
						...
						cek_session_akses_staff('company',$this->session->id_session);
						$data['record'] = $this->Crud_m->view_join_where_ordering_field2('user_company','user_company_level','user_company_kategori','user_company_level_id',array('user_company_status'=>'1'),'user_company_id','ASC');

						$this->load->view('backend/company/v_daftar', $data);
					}elseif ($this->session->level=='4') {
						cek_session_akses_manager('company',$this->session->id_session);
						$data['record'] = $this->Crud_m->view_join_where_ordering_field2('user_company','user_company_level','user_company_kategori','user_company_level_id',array('user_company_status'=>'1'),'user_company_id','ASC');

						$this->load->view('backend/company/v_daftar', $data);
					}elseif ($this->session->level=='5') {
						cek_session_akses_bod('company',$this->session->id_session);
						$data['record'] = $this->Crud_m->view_join_where_ordering_field2('user_company','user_company_level','user_company_kategori','user_company_level_id',array('user_company_status'=>'1'),'user_company_id','ASC');
	...
	public function company_tambahkan()
	{
		...
		if (isset($_POST['submit'])){
			...
			$hasillogo=$this->upload->data();
			$config['image_library']='gd2';
			$config['source_image'] = './assets/backend/images/'.$hasillogo['file_name'];
			$config['create_thumb']= FALSE;
			$config['maintain_ratio']= FALSE;
			$config['quality']= '100%';
			$config['new_image']= './assets/backend/images/'.$hasillogo['file_name'];
			$this->load->library('image_lib', $config);
			$this->image_lib->resize();
			if ($hasillogo['file_name']==''){
									$data = array(
										...
										$data = array(
														...
														if($query){
															unlink("assets/backend/images/".$_image->user_company_logo);
														}
													}

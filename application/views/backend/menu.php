...
<aside class="main-sidebar sidebar-dark-primary elevation-4" >
  ...
  <a href="<?php echo base_url('aspanel/home')?>" class="brand-link" style="background-color: <?php echo $users_company['user_company_warna'];?>; ">
    <center><span class="brand-text font-weight-light" style="color:white;"><strong><?php echo $users_company['user_company_judul'];?>-MS</span></strong></center>
  </a>
...
<div class="sidebar">
  ...
  <nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      <li class="nav-item">
        <img src="<?php echo base_url(); ?>assets/backend/images/<?php echo $users_company['user_company_logo'];?>" class="img-thumbnail" alt="">
      </li>
...
<?php  if($this->session->level=='5' OR $this->session->level=='3' OR $this->session->level=='2'){ ?>

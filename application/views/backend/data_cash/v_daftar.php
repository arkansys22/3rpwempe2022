              ...
              <table id="bank_table1" class="table table-bordered table-striped table-hover" >
                ...
                <tr>
                  ...
                  <td>
                    ...
                    echo "<a style='font-size:12px;' class='btn btn-default btn-sm' title='$row[description]' href='#'> $row[description]</a>";
                      }else{
                    echo"<a style='font-size:12px;' class='btn btn-success btn-sm' title='Verified' href='#'> Verified</a>";}?>
                  </td>
